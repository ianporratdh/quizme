...
const slidesData = [
    {
        ...
        "endPlaybackTime": 20,
        "statement": "Before installing the front wheel, what should you do with the bike?",
        "options": ["Lean it", "Lift it"],
        "rightOption": 1
    },
    {
        "id": 2,
        "video": "videos/videosubtitles.mp4",
        "startPlaybackTime": 106,
        "endPlaybackTime": 118,
        "statement": "After securing the seat post clamp, what should you adjust next?",
        "options": ["Pedals", "Handlebars"],
        "rightOption": 1
    },
    {
        "id": 3,
        "video": "videos/videosubtitles.mp4",
        "startPlaybackTime": 150,
        "endPlaybackTime": 175,
        "statement": "Which tool is mentioned for tightening the pedals?",
        "options": ["Screwdriver", "15 millimeter wrench"],
        "rightOption": 1
    },
    {
        "id": 4,
        "video": "videos/videosubtitles.mp4",
        "startPlaybackTime": 33,
        "endPlaybackTime": 43,
        "statement": "With that being done, let's drop the _____.",
        "options": ["kickstand", "handlebar"],
        "rightOption": 0
    },
    {
        "id": 5,
        "video": "videos/videosubtitles.mp4",
        "startPlaybackTime": 45,
        "endPlaybackTime": 55,
        "statement": "Let's address the tightening of the _____.",
        "options": ["front wheel", "rear wheel"],
        "rightOption": 0
    },
    {
        "id": 6,
        "video": "videos/videosubtitles.mp4",
        "startPlaybackTime": 56,
        "endPlaybackTime": 66,
        "statement": "When you start to feel resistance at the halfway point, give your nut a _____ turn.",
    ...
    },
    {
        "id": 7,
        "video": "videos/videosubtitles.mp4",
        "startPlaybackTime": 117,
        "endPlaybackTime": 127,
        "statement": "Now let's address our _____.",
        "options": ["saddle", "handle"],
        "rightOption": 0
    },
    {
        "id": 8,
        "video": "videos/videosubtitles.mp4",
        "startPlaybackTime": 153,
        "endPlaybackTime": 163,
        "statement": "Once tight, we want to move on to our _____ with our other wrench.",
    ...
    },
    {
        "id": 9,
        "video": "videos/videosubtitles.mp4",
        "startPlaybackTime": 223,
        "endPlaybackTime": 233,
        "statement": "They are different from _____ to _____.",
    ...
    },
    {
        "id": 10,
        "video": "videos/videosubtitles.mp4",
        "startPlaybackTime": 296,
        "endPlaybackTime": 306,
        "statement": "And just like that, you're ready to _____.",
        "options": ["ride", "walk"],
        "rightOption": 0
    }
